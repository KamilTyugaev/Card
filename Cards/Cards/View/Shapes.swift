...
protocol ShapeLayerProtocol:CAShapeLayer{
  init(size:CGSize, fiilColor: CGColor)
}

extension ShapeLayerProtocol{
  init(){
      fatalError("init() не может быть использован для создания экзкземпляра")
  }
}

class CircleLayerShape:CAShapeLayer,ShapeLayerProtocol{
    required init(size: CGSize, fiilColor: CGColor) {
        super.init()
...
class SqureShapeLayer: CAShapeLayer,ShapeLayerProtocol{
    required init(size: CGSize, fiilColor: CGColor) {
        super.init()
...
class CrossShare:CAShapeLayer,ShapeLayerProtocol{
    required init(size: CGSize, fiilColor: CGColor) {
        super.init()
...
class FillShare: CAShapeLayer, ShapeLayerProtocol{
    required init(size: CGSize, fiilColor: CGColor) {
        super.init()
...
class BaсkSideCircle: CAShapeLayer, ShapeLayerProtocol {
    required init(size: CGSize, fiilColor: CGColor) {
        super.init()
        let path = UIBezierPath()
        //рисуем 15 кругов
        ...
        self.path = path.cgPath
        self.strokeColor = fiilColor
        self.fillColor = fiilColor
        self.lineWidth = 1
    }
